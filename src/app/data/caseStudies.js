export const caseStudies = [
  ...
  },
  {
    ...
    description: "Revolutionizing patient care through innovative AI implementation",
    image: "/case-studies/healthcare.jpg",
    category: "Healthcare",
    client: "MediTech Solutions",
    duration: "18 months",
    results: ["30% Faster Diagnosis", "Improved Patient Outcomes", "Reduced Operational Costs"],
    content: {
      overview: "MediTech Solutions, a leading healthcare provider, sought to revolutionize their diagnostic process using artificial intelligence. They needed a solution that could improve accuracy, reduce diagnosis time, and enhance patient care.",
      challenge: "The healthcare provider faced several challenges:\n\n• Long diagnosis times affecting patient care\n• Inconsistent diagnostic accuracy across facilities\n• High operational costs in diagnostic processes\n• Limited integration between different medical systems\n• Growing patient load with limited resources",
      solution: "We developed an AI-powered diagnostic system:\n\n• Implemented machine learning algorithms for image analysis\n• Created a unified patient data management system\n• Developed real-time collaboration tools for medical staff\n• Built predictive analytics for patient outcomes\n• Integrated with existing hospital management systems",
      results: "The implementation achieved remarkable results:\n\n• 30% reduction in diagnosis time\n• 25% improvement in diagnostic accuracy\n• 40% reduction in operational costs\n• 60% faster patient data processing\n• Enhanced collaboration between medical staff\n• Improved patient satisfaction scores",
      technologies: ["Python", "TensorFlow", "Docker", "Kubernetes", "PostgreSQL", "React"],
      testimonial: {
        quote: "The AI-powered diagnostic system has transformed our healthcare delivery. We're now able to provide faster, more accurate diagnoses while reducing costs and improving patient care.",
  ...
  },
  {
    ...
    description: "Implementing Industry 4.0 solutions for a manufacturing giant",
    image: "/case-studies/manufacturing.jpg",
    category: "Manufacturing",
    client: "Global Manufacturing Inc",
    duration: "15 months",
    results: ["45% Efficiency Increase", "30% Cost Reduction", "Zero Downtime"],
    content: {
      overview: "Global Manufacturing Inc, a leading industrial manufacturer, sought to modernize their production facilities with Industry 4.0 technologies. They needed a comprehensive solution to improve efficiency, reduce costs, and enhance quality control.",
      challenge: "The manufacturer faced several challenges:\n\n• Inefficient production processes\n• High operational costs\n• Quality control issues\n• Limited real-time monitoring capabilities\n• Outdated equipment and systems",
      solution: "We implemented a smart manufacturing solution:\n\n• Deployed IoT sensors across production lines\n• Implemented predictive maintenance systems\n• Created real-time monitoring dashboards\n• Developed AI-powered quality control\n• Integrated automated inventory management\n• Built comprehensive analytics platform",
      ...
      technologies: ["Python", "TensorFlow", "IoT", "Azure", "SQL Server", "React"],
      testimonial: {
        quote: "The smart manufacturing implementation has revolutionized our production processes. We've achieved unprecedented efficiency while maintaining the highest quality standards.",
