    ...
    <section className="w-full mx-auto py-16 sm:py-16 px-4 sm:px-8" aria-label="About us">
      ...
      <div className="mb-8 sm:mb-12">
        <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-light text-gray-400 mb-2 leading-tight">
          TekReign is a <span className="font-bold text-gray-900">next-generation technology agency</span> that ships{' '}
          <span className="font-bold text-gray-900">production-grade products</span>—including{' '}
          <a
            href="https://kampalo.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="font-bold text-[#8958FE] hover:underline underline-offset-4"
          >
            KAMPALO
          </a>
