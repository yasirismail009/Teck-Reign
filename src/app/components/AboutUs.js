...
export default function AboutUs() {
  return (
    <section className="w-full mx-auto py-16 sm:py-16 px-4 sm:px-8">
      ...
      <div className="flex overflow-x-auto lg:flex-row md:flex-row sm:flex-col flex-col justify-start sm:justify-between items-center gap-4 sm:gap-8 mb-8 sm:mb-16 px-2 scrollbar-hide">
        {features.map((feature, idx) => (
          <div key={idx} className="flex flex-col items-center sm:py-4 lg:py-0 lg:min-w-[120px] md:min-w-[120px] sm:min-w-full w-full">
            <div className="mb-2 transform lg:scale-75 md:scale-75 sm:scale-100 scale-100">{feature.icon}</div>
