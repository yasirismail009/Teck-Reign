          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                {caseStudy.live_link && (
                  <div>
                    <span className="text-[#7B819A] block mb-2 text-sm font-medium">Live Project</span>
                    <a 
                      href={caseStudy.live_link}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-green-600 text-green-600 font-medium text-sm bg-transparent hover:bg-green-600 hover:text-white transition-colors"
        ...
        >
          ...
          {caseStudy.live_link && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-green-700 transition-colors text-center shadow-lg flex items-center justify-center gap-2"
              title="Open live project in new tab"
            >
